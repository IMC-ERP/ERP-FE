...
import { ChevronDown, ChevronRight, Plus, Trash2, DollarSign, Calculator, Archive, AlertCircle, ArrowUpDown, ArrowUp, ArrowDown, X } from 'lucide-react';
...
interface RawMaterial {
  ...
  category: string;
  name: string;
  purchasePrice: number; // 구매가 (예: 7000원)
  purchaseUnitQty: number; // 구매 용량 (예: 1000)
  unit: string; // 단위 (ml, g, ea)
  currentStock: number;
}

interface RecipeIngredient {
  id: string;
  materialId: string; // Link to RawMaterial
  qty: number;
}
...
const INITIAL_MATERIALS: RawMaterial[] = [
  ...
  // New Materials for additional recipes
...
const INITIAL_RECIPES: MenuRecipe[] = [
  {
    ...
    salePrice: 4000,
    ingredients: [
      { id: 'i1', materialId: 'm1', qty: 20 }, // 20g 원두
      { id: 'i2', materialId: 'm6', qty: 1 }, // 컵 1개
    ]
  },
  {
    id: 'r2',
    name: 'Caffè Latte (Ice)',
    salePrice: 4500,
    ingredients: [
      { id: 'i1', materialId: 'm1', qty: 20 },
      { id: 'i2', materialId: 'm2', qty: 200 }, // 우유 200ml
  ...
  },
  {
    ...
    salePrice: 5500,
    ingredients: [
      { id: 'i1', materialId: 'm5', qty: 80 }, // 딸기 80g
      { id: 'i2', materialId: 'm2', qty: 250 }, // 우유 250ml
      { id: 'i3', materialId: 'm4', qty: 20 }, // 시럽 20ml
  ...
  },
  {
    ...
    ingredients: [
       { id: 'i1', materialId: 'm1', qty: 20 }, 
       { id: 'i2', materialId: 'm2', qty: 180 },
       { id: 'i3', materialId: 'm8', qty: 30 }, // Choco Sauce
       { id: 'i4', materialId: 'm6', qty: 1 }
    ]
  },
  {
    ...
    salePrice: 5200,
    ingredients: [
       { id: 'i1', materialId: 'm9', qty: 30 }, // Matcha Powder
       { id: 'i2', materialId: 'm2', qty: 200 },
       { id: 'i3', materialId: 'm6', qty: 1 }
    ]
  },
  {
    id: 'r10',
    name: 'Chocolate Latte (Ice)',
    salePrice: 5000,
    ingredients: [
       { id: 'i1', materialId: 'm8', qty: 40 }, // Choco Sauce
       { id: 'i2', materialId: 'm2', qty: 200 },
       { id: 'i3', materialId: 'm6', qty: 1 }
    ]
  },
  {
    ...
    salePrice: 5800,
    ingredients: [
       { id: 'i1', materialId: 'm5', qty: 150 }, // Frozen Strawberry
  ...
  },
  {
    ...
    salePrice: 5500,
    ingredients: [
       { id: 'i1', materialId: 'm10', qty: 60 }, // Yogurt Powder
  ...
  },
  {
    ...
    salePrice: 4000,
    ingredients: [
       { id: 'i1', materialId: 'm11', qty: 40 }, // Peach Syrup
...
interface RecipeRowProps {
  ...
  onUpdateMeta: (id: string, field: keyof MenuRecipe, value: any) => void;
  onUpdateIngredient: (recipeId: string, ingId: string, field: keyof RecipeIngredient, value: any) => void;
...
interface MaterialTableProps {
  materials: RawMaterial[];
  onUpdate: (id: string, field: keyof RawMaterial, value: any) => void;
  onDelete: (id: string) => void;
}

const MaterialTable: React.FC<MaterialTableProps> = ({ materials, onUpdate, onDelete }) => {
  // Group by Category for better view as requested
...
export const CostRecipeManager = () => {
  ...
  const handleUpdateMaterial = (id: string, field: keyof RawMaterial, value: any) => {
  ...
  const handleUpdateIngredient = (recipeId: string, ingId: string, field: keyof RecipeIngredient, value: any) => {
    setRecipes(prev => prev.map(r => {
      if (r.id !== recipeId) return r;
      return {
        ...r,
  ...
  const handleUpdateRecipeMeta = (recipeId: string, field: keyof MenuRecipe, value: any) => {
    ...
    <div className="space-y-6 animate-fade-in relative">
      ...
      <div className="flex gap-2 border-b border-slate-200">
        <button
          ...
          className={`flex items-center gap-2 px-6 py-3 text-sm font-bold rounded-t-lg transition-colors ${
            activeTab === 'recipe' 
