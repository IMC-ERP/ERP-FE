 ...
 * Auth + ERP Layout + AI Monstock 라우트 통합
 */
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            KPI는 단독 분석보다 경영 현황, 매출 분석, AI Monstock 화면과 함께 볼 때 의미가 큽니다. 지금은 이 요약을 기준으로 상세 화면으로 바로 이어서 보는 흐름이 가장 적합합니다.
          </p>
        </div>
      </div>
    </div>
          ...
          <Routes>
            ...
            >
              ...
              <Route
                path="ai"
                element={(
                  <Suspense fallback={<div className="p-6 text-slate-400">AI Monstock 로딩 중...</div>}>
                    <AIAssistant />
                  </Suspense>
                )}
              />
